...
public class SerializationTest
{
    ...
    public void SerializeTest1()
    {
        ...
        var serialized = SerializeUtil.SerializeObject(objectTest);
        var unserialized = SerializeUtil.DeserializeObject<Tuple<int, string, List<object>, float>>(serialized);
    ...
    private static bool EqualsTuples(Tuple<int, string, List<object>, float>? t1,
        Tuple<int, string, List<object>, float>? t2)
    {
        if (t1 == null && t2 == null)
            return true;
        if (t1 == null || t2 == null)
